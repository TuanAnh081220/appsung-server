...
#         'google/vit-base-patch16-224-in21k', 'vinai/phobert-base'
#     )
#     model.save_pretrained("vit-phoBert")
#     model_vit_phoBert = TFVisionEncoderDecoderModel.from_pretrained("vit-phoBert")
#     return model_vit_phoBert
#
#
# # def train():
...
#     #     train()
#     model_ = get_model()
#     # model_.load_weights('pretrained_weights.h5', by_name=True, skip_mismatch=True)
